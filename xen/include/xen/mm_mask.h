...
#define RTXEN_L3CACHE_COLORS    (RTXEN_L3CACHE_SIZE / RTXEN_L3CACHE_ASSOC / RTXEN_PAGE_SIZE)
#define RTXEN_L3CACHE_COLOR_MFN_MASK (RTXEN_L3CACHE_COLORS-1)
#define RTXEN_GET_L3CACHE_COLOR_MFN(p)  (p & RTXEN_L3CACHE_COLOR_MFN_MASK)
